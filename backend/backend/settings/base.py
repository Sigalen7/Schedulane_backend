...
DATABASES = {
    'default': {
        ...
        'NAME': "schedulane_db",                               # Replace with your PostgreSQL database name
        'USER': "schedulane_user",                      # Replace with your PostgreSQL username
        'PASSWORD': "Amiraev@19",              # Replace with your PostgreSQL password
        'HOST': "127.0.0.1",                               # Replace with "localhost"
